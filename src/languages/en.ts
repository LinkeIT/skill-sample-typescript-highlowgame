...
import { ILangStrings } from "./ILangStrings";

export const enData: i18next.ResourceLanguage = {
  translation: {
    SKILL_NAME: "High Low Game",
    EXIT_MESSAGE: "Thanks for playing!",
    FALLBACK_MESSAGE_DURING_GAME: `The %s skill can't help you with that.  Try guessing a number between 0 and 100. `,
    FALLBACK_REPROMPT_DURING_GAME: "Please guess a number between 0 and 100.",
    FALLBACK_MESSAGE_OUTSIDE_GAME: `The %s skill can't help you with that.  It will come up with a number between 0 and 100 and you try to guess it by saying a number in that range. Would you like to play?`,
    FALLBACK_REPROMPT_OUTSIDE_GAME: "Say yes to start the game or no to quit.",
    GUESS_CORRECT_MESSAGE: "%s is correct! Would you like to play a new game?",
